---
description: Generate the agentic.md orchestrator for the new workflow (Step 3).
...
Generate a complete agentic.md following the template structure.
Present to user and wait for approval before saving.
