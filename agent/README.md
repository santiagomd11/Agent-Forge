...
- `Prompts/`, specialized agent prompts used by the orchestrator:
  - `02_Workflow_Architect.md`, designs workflow structures from requirements
  - `03_Prompt_Writer.md`, creates agent prompts following the canonical template
  - `04_Quality_Reviewer.md`, reviews generated workflows for completeness
