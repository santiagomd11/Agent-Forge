...
| `forge/Prompts/` (agent prompts) | `output/{name}/agent/Prompts/` (agent prompts) |
| `forge/scripts/` (automation) | `output/{name}/agent/scripts/` (automation) |
| `forge/utils/` (reference material) | `output/{name}/agent/utils/` (reference material) |
