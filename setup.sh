...
cmd_help() {
    ...
    echo "  pack       Package an agent folder into .agnt archive"
    echo "  pull       Download and install an agent from a registry"
    echo "  push       Publish a .agnt file to a registry"
    echo "  search     Search registries for agents"
